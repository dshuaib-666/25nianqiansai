...
//	
//		voice.Rx_len =  100 - temp; 
//		
//		//openmv_data_get();
////		OPENMV_RECEVIE_unpack();
////		  FOURG_RECEVIE_unpack();//gai
//		//recv_end_flag = 1;	
//	
//	 }
//	HAL_UART_Receive_DMA(&huart1,voice.voice_buffer,100);//gai 
	...
	{  
		...
		openmv.Rx_len =  100 - temp; 
		
		//openmv_data_get();
			OPENMV_RECEVIE_unpack();
//		  FOURG_RECEVIE_unpack();//gai
		//recv_end_flag = 1;	
//		VOICE_RECEVIE_unpack();
	 }
	HAL_UART_Receive_DMA(&huart1,openmv.openmv_buffer,100);//gai 
...
//		  FOURG_RECEVIE_unpack();//gai
	...
	HAL_UART_Receive_DMA(&huart4,voice.voice_buffer,100);//gai
